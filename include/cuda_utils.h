...
#define DISPATCH_DTYPE(dtype, func, ...)                                \
    switch (dtype) {                                                    \
        case cudaoplib::DType::Float32: func(float{}, ##__VA_ARGS__); break;    \
        case cudaoplib::DType::Float16: func(__half{}, ##__VA_ARGS__); break;   \
        case cudaoplib::DType::Int32:   func(int{}, ##__VA_ARGS__); break;      \
        case cudaoplib::DType::Int8:    func(int8_t{}, ##__VA_ARGS__); break;   \
